            ...
            <div class="card card-outline card-primary">
                 <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{url('admin/alumnos/create')}}" class="btn btn-primary">
                              Registrar nuevo
                        </a>
                    </div>
                 </div>
 ...
 <table id="example1" class="table table-striped table-bordered table-hover table table-sm">
  <thead>
    <tr>
       ...
       <td style="text-align: center"><b>Numero de control</b></td>
       <td style="text-align: center"><b>Carrera</b></td>
       <td style="text-align: center"><b>Semestre</b></td>
       <td style="text-align: center"><b>Correo</b></td>
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{url('admin/alumnos/'.$alumno->id)}}" type="button" class="btn btn-info btn-sm"><i class="bi bi-eye"></i></a>
                        <a href="{{url('admin/alumnos/'.$alumno->id.'/edit')}}" type="button" class="btn btn-success btn-sm"><i class="bi bi-pencil"></i></a>
                        <a href="{{url('admin/alumnos/'.$alumno->id.'/confirm-delete')}}" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a>
                    </div>
                </td>
            </tr>
        @endforeach
